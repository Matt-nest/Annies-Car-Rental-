...
export default function PendingCounterSignWidget() {
  ...
  return (
    <>
      <motion.div
        data-widget="pending-counter-sign"
        initial={{ opacity: 0, y: 16 }}
        animate={{ opacity: 1, y: 0 }}
        style={{
          background: 'var(--bg-card, #fff)',
          borderRadius: 16,
          border: '1.5px solid rgba(70, 95, 255, 0.25)',
          overflow: 'hidden',
          boxShadow: '0 1px 3px rgba(0,0,0,0.04), 0 0 0 1px rgba(70,95,255,0.05)',
        }}
      >
        {/* Header */}
        <div style={{
          padding: '16px 20px',
          background: 'linear-gradient(135deg, rgba(70,95,255,0.06) 0%, rgba(70,95,255,0.03) 100%)',
          borderBottom: '1px solid rgba(70,95,255,0.1)',
          ...
          <div style={{
            ...
            boxShadow: '0 2px 8px rgba(70,95,255,0.3)',
          }}>
            ...
            {pending.map((ag, i) => {
              ...
              return (
                <motion.div
                  ...
                  onMouseEnter={e => e.currentTarget.style.background = 'rgba(70,95,255,0.03)'}
                ...
                >
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 3 }}>
                      ...
                      <span style={{ fontSize: '10px', color: '#465FFF', fontWeight: 500, background: 'rgba(70,95,255,0.08)', padding: '1px 6px', borderRadius: 4 }}>
                        {ag.booking_status}
                      </span>
                    </div>
                  ...
                  <div style={{ display: 'flex', gap: 6 }}>
                    <motion.button
                      ...
                      style={{
                        ...
                        boxShadow: '0 2px 6px rgba(70,95,255,0.25)',
                      }}
                    >
