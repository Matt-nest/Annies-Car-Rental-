    ...
    <>
      <motion.div
        ...
        style={{
          ...
          overflow: 'hidden',
          boxShadow: '0 1px 3px rgba(0,0,0,0.04), 0 0 0 1px rgba(0,122,255,0.05)',
        }}
      >
        {/* Header */}
        <div style={{
          padding: '16px 20px',
          background: 'linear-gradient(135deg, rgba(0,122,255,0.06) 0%, rgba(0,102,221,0.03) 100%)',
                ...
                >
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 3 }}>
                      ...
                      <span style={{ fontSize: '10px', color: '#007AFF', fontWeight: 500, background: 'rgba(0,122,255,0.08)', padding: '1px 6px', borderRadius: 4 }}>
                        {ag.booking_status}
                      </span>
                    </div>
