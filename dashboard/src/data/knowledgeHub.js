...
export const KNOWLEDGE_GUIDES = [
  ...
  },
  {
    ...
    category: 'system',
    time: '4 min',
    summary: 'Where to look when payments, messages, insurance, automation, or customer links behave wrong.',
    ...
    doneWhen: 'Health, payment provider, notification settings, Bonzah, and automation failures have been checked.',
    escalateIf: 'Failures repeat, live customers are affected, or provider/dashboard states disagree.',
    doNotProceedIf: [
      'A payment, agreement, insurance, or booking-status event has a failed automation event.',
    ...
    routeLabel: 'Settings',
    routePath: '/settings',
    tags: ['settings', 'system', 'automation'],
    searchKeywords: ['system health', 'settings', 'automation failures', 'stripe', 'square', 'push notifications', 'sms', 'resend', 'twilio', 'bonzah test connection', 'environment variables'],
    steps: [
    ...
    demo: [
      ...
      dashboardFrame({
        ...
        caption: 'Use Bonzah Test Connection, recent activity, provider screens, and Automation Failures before retrying customer work.',
        focusId: 'provider',
        cursor: { x: 68, y: 53 },
        blocks: [
          { id: 'provider', label: 'Bonzah / payment provider status', x: 20, y: 27, w: 36, h: 38, type: 'card' },
          { id: 'failures', label: 'Automation failures', x: 62, y: 27, w: 24, h: 38, type: 'list' },
        ],
      }),
    ],
  },
