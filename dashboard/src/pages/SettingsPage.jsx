      ...
      <div className="space-y-3">
        ...
        {push.permission === 'denied' && (
          <div className="flex items-start gap-2.5 bg-[rgba(239,68,68,0.06)] border border-[rgba(239,68,68,0.18)] rounded-xl p-3 text-xs text-[#ef4444]">
            ...
            <div>
              Notifications are blocked by your browser/OS settings. On iPhone: Settings → Notifications → Annie's Dashboard → Allow Notifications. Then come back here and toggle on.
            </div>
          </div>
        )}
