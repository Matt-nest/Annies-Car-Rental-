...
export default function FAQ() {
  const faqs = [
    ...
    { q: 'Is there a mileage limit?', a: 'Every rental includes 150 miles per day. Need more? Just let us know when booking and we\'ll work out a rate that fits your trip.' },
    ...
    { q: 'What additional fees could apply?', a: 'We keep pricing transparent. Beyond your rental rate, fees only apply if you incur them: tolls and traffic violations ($50 admin fee each), fuel refill ($20 per quarter tank), late returns ($30/day), or excessive cleaning/smoking/pet damage (up to $250). These incidentals are deducted from your refundable security deposit.' },
