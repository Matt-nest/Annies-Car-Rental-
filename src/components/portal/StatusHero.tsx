...
const CONFIGS: Record<BookingStatus, HeroConfig> = {
  ...
  completed: {
    label: 'Trip Complete',
    headline: 'Thanks for renting with us',
    icon: CheckCircle2,
    fg: '#22c55e',
    bg: 'rgba(34,197,94,0.08)',
    borderRgba: 'rgba(34,197,94,0.22)',
...
function useCountdownCopy({
  ...
  switch (status) {
    case 'pending_approval':
      return { label: 'We typically respond within 30 minutes', tone: 'neutral' as const };
    case 'approved':
    case 'confirmed': {
    ...
    case 'cancelled':
    case 'declined':
      return { label: 'Contact us if this is unexpected', tone: 'neutral' as const };
  }
}
