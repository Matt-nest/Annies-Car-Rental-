...
export const ACKNOWLEDGEMENTS = [
  'Customer will fill the fuel tank at the indicated level before return of the Vehicle. Failure to refill the tank will result in a charge of $20.00 per quarter tank of fuel.',
